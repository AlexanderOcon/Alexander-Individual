...
const Encabezado = () => {
  ...
  const claseNav = (ruta) => {
    ...
    if (mostrarMenu) {
      return activo ? "color-texto-marca fw-bold" : "color-texto-marca";
    }
    return activo ? "text-white nav-link-discosa-activo" : "text-white";
  };
